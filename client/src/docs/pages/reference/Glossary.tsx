...
const TERMS: [string, ReactNode][] = [
  ...
  ["App", "An app id within one VeraKey deployment. Apps on the VeraKey origin share its rpId, so one passkey serves them all, yet each gets its own account. An app on another domain needs its own VeraKey deployment, relayer and passkey."],
