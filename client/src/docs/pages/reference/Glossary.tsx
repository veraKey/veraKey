...
const TERMS: [string, ReactNode][] = [
  ...
  ["Disclosure", <>A package that proves to one named audience that one passkey owns two app accounts, until it expires. VeraKey calls this linkable by consent. See <A href="/docs/guides/disclosures">Prove two accounts are yours</A>.</>],
