...
`}</Code>
      ...
      <Table
        ...
        rows={methods([
          ...
          ["VeraKeyConnectError", "{ code, message, revert?, hash?, pending? }", "Why a request failed. hash: the payment was sent. pending: it may have been sent; find it with findPayment."],
