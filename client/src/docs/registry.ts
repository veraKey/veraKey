...
export const PAGES: DocPage[] = [
  ...
  },
  {
    ...
    sections: ["How sign-in works", "Add the button", "Verify on your server", "Take a payment", "Develop locally", "Test your integration", "Security checklist", "Errors and limits"],
    headingKeywords: {
      "Add the button": ["VeraKeyConnect", "signIn"],
      "Verify on your server": ["verifySignIn"],
      "Take a payment": ["pay", "verifyPayment"],
      "Develop locally": ["localhost", "127.0.0.1", "origin", "proxy"],
      "Test your integration": ["Playwright", "end-to-end", "virtual passkey authenticator", "data-testid"],
