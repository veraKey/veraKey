      ...
      <header className="site-nav">
        <div className="container nav-inner">
          ...
          <div className="nav-actions">
            <button className="nav-github" onClick={openDocs} aria-label="Documentation">
              <Terminal size={17} />
            </button>
